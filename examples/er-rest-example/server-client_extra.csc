...
<simconf>
  ...
  <simulation>
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>176.4055546616601</x>
        <y>81.60459236460525</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>157.47344582550372</x>
        <y>45.12565094859662</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.1656330182139327 0.0 0.0 2.1656330182139327 38.97030622836615 -60.72559966267773</viewport>
    </plugin_config>
    <width>604</width>
    <z>1</z>
    <height>423</height>
