...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples/ipv6/ids/evaluation/ids-rpl-collect-sink/udp-sink.c</source>
      <commands EXPORT="discard">make udp-sink.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples/ipv6/ids/evaluation/ids-rpl-collect-sink/udp-sink.sky</firmware>
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>249.82023394283686</x>
        <y>-55.071148925279296</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>246.52587119377185</x>
        <y>-29.06478593826099</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.2518652174385316 0.0 0.0 2.2518652174385316 -276.1430345399865 210.44998050666646</viewport>
    </plugin_config>
    <width>498</width>
    <z>1</z>
    <height>278</height>
